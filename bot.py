...
SCHEDULE = {
    0: [  # Понедельник
        ("15:00", "Выход", "ВДА", "м. Технологический институт", "ул. Егорова, 11, цокольный этаж, вход с улицы, помещение «Хаски». +7 911 995-25-35, Евгения. t.me/+sQ0gunx02..."),
        ...
        ("19:00", "Подруги", "ВДА", "м. Владимирская/Достоевская", "Щербаков пер., 12, ДЦ Владимирский. Женская группа. vk.com/spb_aca_girls, t.me/spb_aca_girls"),
    ...
    1: [  # Вторник
        ("16:00", "Чёрная речка", "ВДА", "м. Чёрная речка", "Сестрорецкая ул., 2. Вход с Сестрорецкой улицы через магазин «Рыбалка». Чат группы: t.me/+la-lJbgvZ..."),
        ("17:30", "Лотос", "ВДА", "м. Ленинский проспект", "Трамвайный пр., 12к2, 5 этаж, комната 33. +7 921 904-49-86. vk.com/club188163037"),
        ("18:45", "Вместе", "ВДА", "м. Технологический институт", "1-я Красноармейская ул., 11, Собор Успения Пресвятой Девы Марии, цокольный этаж: через главный зал, направо вниз по лестнице, затем направо по коридору, по указателям. +7 921 633-43-32, Алёна. t.me/+3LbXeWKvr..."),
    ...
    2: [  # Среда
        ...
        ("18:45", "Небо на Тореза", "CoDA", "м. Площадь Мужества", "пр. Тореза, 32, Библиотека им. Д. С. Лихачёва. +7 911 952-70-73. https://t.me/nebo_coda"),
        ("19:00", "Здравствуй, Я!", "ВДА", "м. Балтийская/Фрунзенская", "наб. Обводного канала, 116, ауд. 121, возле Варшавского вокзала. На территории Храма Воскресения Христова, в кирпичном домике, где туалеты, 1 этаж, прямо до конца коридора, направо. +7 906 246-56-93, Марина. t.me/+leT0VsACS..., vk.ru/club236966318"),
        ("19:00", "Прометей", "ВДА", "м. Московская/Проспект Славы", "пр. Славы, 4, после арки направо, вывеска «Автошкола», 2 этаж, последняя дверь налево. +7 911 277-49-11, Анастасия. vk.ru/vda_prometei"),
        ("19:00", "Решение", "ВДА", "Всеволожск", "Всеволожск, Всеволожский пр., 62, 2 этаж, на территории церкви. Предварительно позвонить. +7 965 790-84-63, Юрий"),
        ("19:00", "Феникс", "ВДА", "м. Василеостровская/Спортивная", "2-я линия В.О., 3, «Информационный кабинет», лестница вниз. +7 965 787-05-74. t.me/+MqZjzIhuK..."),
        ("19:10", "Путь к себе", "CoDA", "м. Сенная/Садовая/Спасская", "Б. Подъяческая, 34, РБОО «АЗАРИЯ». +7 911 928-67-10. Рабочее собрание — первый четверг месяца 20:05. День рождения группы — 9 августа 1999 года."),
        ("19:15", "Крылья", "ВДА", "Выборг", "Выборг, ул. Кленовая, 2, 1 этаж. t.me/+FqSI0EZyI..."),
    ...
    3: [  # Четверг
        ...
        ("19:00", "Эфир", "ВДА", "м. Московская", "ул. Варшавская, 122, каб. 10, цокольный этаж, домофон «6». +7 999 037-13-05, Наталья. t.me/+KPUbhUb_2..."),
    ...
    4: [  # Пятница
        ("10:15", "Доверие", "ВДА", "Колпино", "Колпино, ул. Анисимова, 5, корп. 7, вагончик за церковью Сошествия Святого Духа. С собой нужно принести сменную обувь. +7 911 967-25-38, Оксана"),
        ("18:10", "Ручей", "ВДА", "м. Чкаловская", "ул. Колпинская, 27, пространство выздоровления «Ручей»"),
        ("18:30", "ЮТА", "UAA", "", "адрес уточняйте на uaarus.ru"),
        ("19:00", "Любящий родитель", "ВДА", "м. Балтийская", "наб. Обводного канала, 116, помещение «Лекционка» в храме, центральный вход. Напротив поста охраны налево, коричневая дверь, подняться наверх за хоры. Важно не опаздывать: в 19:30 храм закрывают под группу. Валерия, +7 952 236-77-44"),
        ("19:00", "Небо на Обводном", "CoDA", "м. Балтийская", "наб. Обводного канала, 116, храм Воскресения Христова, здание воскресной школы — отдельное 3-этажное кирпичное здание на улице. +7 911 952-70-73. https://t.me/nebo_coda"),
    ...
    5: [  # Суббота
        ("10:30", "Жемчужина", "ВДА", "Пушкин", "Пушкин, ул. Магазейная, 22/30, помещение клуба «Восхождение». +7 969 211-26-96"),
        ("11:00", "Взрослые девочки — интенсив 10 шага", "ВДА", "м. Василеостровская", "13-я линия В.О., 2, кв. 46, синяя дверь во дворе. Открытый интенсив для женщин по 10 шагу ВДА по БКК и ЖТ. Приглашаются те, кто прошёл 9 шагов"),
        ...
        ("15:00", "Петергоф", "ВДА", "Петергоф", "Петергоф, Калининская ул., 3Ж, вход со стороны Лихардовской улицы, нужная дверь справа от студии керамики «Облепиха». Берите с собой сменную обувь или бахилы. +7 921 847-60-41, Ирина. vk.com/club217670292"),
        ...
        ("18:30", "ЮТА", "UAA", "", "адрес уточняйте на uaarus.ru"),
        ("19:00", "Солнечная сторона", "ВДА", "м. Чернышевская", "ул. Радищева, 30, пространство «Просвет», зал «Просвещение». t.me/+qFRjoIzA_..."),
        ("19:00", "Феникс", "ВДА", "м. Василеостровская/Спортивная", "2-я линия В.О., 3, «Информационный кабинет», лестница вниз. +7 965 787-05-74. t.me/+MqZjzIhuK..."),
        ("20:15", "Замысел", "UAA", "м. Сенная/Садовая/Спасская", "ул. Ефимова, 6"),
    ],
    6: [  # Воскресенье
        ...
        ("15:00", "Воскресенье", "ВДА", "м. Автово", "ул. Маршала Захарова, 13, подъезд 3, цокольный этаж. Домофон 222. +7 918 351-04-44, Елена. t.me/voskresenj..."),
        ...
        ("15:15", "ВДАтин", "ВДА", "м. Василеостровская/Спортивная", "Группа для подростков 12–18 лет из алкогольных и/или дисфункциональных семей. 2-я линия В.О., 3, «Информационный кабинет», лестница вниз. +7 931 120-41-24. t.me/VDAtin"),
        ...
        ("18:00", "Прометей", "ВДА", "м. Московская/Проспект Славы", "пр. Славы, 4, после арки направо, вывеска «Автошкола», 2 этаж, последняя дверь налево. +7 911 277-49-11, Анастасия. vk.ru/vda_prometei"),
