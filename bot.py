...
SCHEDULE = {
    ...
    1: [  # Вторник
        ("16:00", "Чёрная речка", "ВДА", "м. Чёрная речка, Сестрорецкая ул., 2, вход через магазин «Рыбалка». https://t.me/+la-lJbgvZrhkMzgy"),
    ...
    2: [  # Среда
        ...
        ("18:00", "Солнечная сторона", "ВДА", "м. Чернышевская, ул. Радищева, 30, Пространство «Просвет», зал Просвещение."),
